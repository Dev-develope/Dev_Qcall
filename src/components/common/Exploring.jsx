            ...
            <div className="min-h-[22rem] flex flex-co text-center justify-center items-center">
              <div className="d-flex flex-col justify-center items-center">
                ...
                <p className="mt-4 max-w-2xl mx-auto  text-sm sm:text-base">
                  Experience expectaional support deom our dedicated team who
                  are ready to assist you <br />
                  around the clock.Explore our support center for a wealth of
                  self learrning resources.
                </p>
                ...
                <div className="mt-6 flex flex-wrap justify-center gap-3 sm:gap-4">
                  ...
                  />
                  <CommonButton
                    className="bg-white  text-black hover:text-[#00a7e6] text-xs sm:text-sm font-bold px-4 sm:px-6 py-2 sm:py-3 shadow-lg"
                    title="Book a demo"
