...
import { ArrowLeft, ArrowLeftIcon, ArrowRightIcon, SearchIcon } from "lucide-react";
...
const BlogPost = ({data}) => {
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-10 mt-10">
        {/* Breadcrumb Navigation */}
        <div className="text-sm text-gray-500 mb-4 flex flex-col">
          <Link href="/blog" className="text-black text-center border border-[#00a7e6] py-2 rounded-2xl max-w-[7rem] font-bold">
            Go Back
          </Link>
          <div className="mt-4">
            <Link href="#" className="hover:underline">BLOG</Link> &gt;{" "}
            <Link href="#" className="hover:underline">{data?.category}</Link> &gt;{" "}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-8 mt-5  border-t border-t-[#00a7e6] py-10">
              <div className="flex flex-col p-4 border border-gray-200 rounded-2xl">
                <ArrowLeftIcon />
                <span className="text-gray-500 text-sm mt-2">PREVIOUS BLOG</span>
                <h1 className="font-bold text-lg mt-2">Revolutionizing Customer Interaction: Harnessing
                  AI Voicebots in Telecommunication</h1>
              </div>
              <div className="flex flex-col p-4 border border-gray-200 rounded-2xl">
            ...
            <div className="max-w-3xl mx-auto p-6 rounded-lg">
              ...
              <CommonButton className="mt-6 px-4 py-2 bg-blue-500 text-white font-semibold rounded-md hover:bg-blue-600 transition" title="Submit" />
            </div>
          </div>
          ...
          <aside>
            ...
            <div className="relative mb-6">
              ...
              />
              <button className="absolute right-2 top-2 text-[#00a7e6]"><SearchIcon /></button>
            </div>

            {/* Recent Posts */}
            <h2 className="text-lg font-semibold text-gray-900 mb-3">Recent Posts</h2>
            <ul className="space-y-3 text-sm text-gray-600">
              <li><Link href="#" className="hover:text-[#00a7e6]">Transforming Communication: The Benefits of an AI Voicebot...</Link></li>
              <li><Link href="#" className="hover:text-[#00a7e6]">Elevate Your Calling Experience: The Impact of AI Voicebots...</Link></li>
              <li><Link href="#" className="hover:text-[#00a7e6]">Enhancing Customer Engagement with AI Voicebots for Call Handling</Link></li>
              <li><Link href="#" className="hover:text-[#00a7e6]">Revolutionizing Communication: The Ultimate AI Voicebot...</Link></li>
            </ul>
          </aside>
        </div>
      </div>
