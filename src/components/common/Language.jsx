                ...
                <div className="flex flex-col lg:flex-row justify-center items-center">
                    ...
                    <div className="w-full lg:w-1/3 flex flex-col justify-center">
                        ...
                        <h2 className="text-xl md:text-2xl font-bold text-white mt-4">
                            QCall.ai Supports <br className="hidden md:block" />Multiple Languages
                        </h2>
                        ...
                        <div className="mt-6">
                            <CommonButton title="Explore More Voices" className="bg-[#00a7e6] rounded-full text-white text-sm transition" route="http://localhost:3000/explore-ai-voice"/>
                        </div>
                    </div>
