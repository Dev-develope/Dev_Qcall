...
export default function RecruitmentLandingPage({ data }) {
  return (
    <div className="bg-[#0a1328] text-white  flex flex-col items-center py-15 px-4">
        ...
        {/* Headings */}
        <h1 className="text-4xl font-bold mt-4 mb-3 text-center max-w-3xl">
          {data?.title}
        </h1>
        {data?.subtitle && (
        ...
        {/* Description */}
        {data?.description && (
          <p className="text-center text-gray-400 max-w-xl mt-4 mb-8">
            {data?.description}
          </p>
        )}
      ...
      <FarmerMotionCardCenter>
        ...
        {data?.trustDescription && (
          <p className="text-center text-gray-400 max-w-2xl mt-4 mb-8">
            {data?.trustDescription}
          </p>
        )}
